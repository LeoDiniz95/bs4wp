        ...
        <?php  if(  have_comments(  ) && comments_open(  )  ) : ?>
            ...
            <div class="list-unlysted">
                ...
                <?php   $comments_arg = array(
                    'title_reply'               => 'Escreva uma resposta',
                    'title_reply_before'        => '<h6 id="reply-title" class="comment-reply-title mt-4">',
                    'title_reply_after'         => '</h6>',
                    'class_submit'              => 'btn btn-my-color-3',
                    'comments_notes_before'     => '<p>Seu e-mail não será publicado.</p>',
                    'fields'                    => apply_filters( 'comment_form_default_fields', array(
                        'author'                => '<div class="row"><div class="col-md-6 col-sm-12"><div class="form-group"><label class="control-label" for="author">'. __('Seu nome') . '</label>' . ($req ? '<span>*</span>' :   '').
